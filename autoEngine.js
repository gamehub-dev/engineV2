...
function engineCollision() {
        if (!imgMovement) {
            ...
            for (let i = 0; i < engineBlocks.length; i++) {
                ...
                if (enginePlayer.x <= engineBlocks.at(i).x + engineBlocks.at(i).w && enginePlayer.x + enginePlayer.w > engineBlocks.at(i).x && enginePlayer.y + enginePlayer.h > engineBlocks.at(i).y && enginePlayer.y < engineBlocks.at(i).y + engineBlocks.at(i).h - 10) { enginePlayer.x = engineBlocks.at(i).x + engineBlocks.at(i).w };
