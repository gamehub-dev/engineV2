...
function engineCollision() {
        if (!imgMovement) {
            ...
            if (enginePlayer.y <= engineBlocks.at(i).y + engineBlocks.at(i).h + 5 && enginePlayer.y + enginePlayer.h > engineBlocks.at(i).y + 10 && enginePlayer.x + enginePlayer.w > engineBlocks.at(i).x && enginePlayer.x < engineBlocks.at(i).x + engineBlocks.at(i).w) { enginePlayer.y = engineBlocks.at(i).y + engineBlocks.at(i).h + 5; if (engine.gravity){enginePlayer.y = engineBlocks.at(i).y + engineBlocks.at(i).h ,enginePlayer.vy += enginePlayer.mass }else{enginePlayer.y = engineBlocks.at(i).y + engineBlocks.at(i).h}};
            };
        };
    };
// asd
